...
## Meet ELD
Version 1.0 of the calcuator, now directly hosted on Repl.it as well as GitHub.  No need now to copy source code!  Just go to [this link](https://repl.it/@micahlt/ELD) to run the program.
